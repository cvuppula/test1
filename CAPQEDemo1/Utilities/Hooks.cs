...
namespace CAPQEDemo1.Utilities
{
    ...
    public sealed class Hooks : BaseTest
    {
        ...
        //    extentReport.AddSystemInfo("Environment", "CAP QE Environment Automation Report");
        ...
        //                .Fail(Capture(webDriver, "Screenshot_" + DateTime.Now.ToString("MM_dd_yyyy HH-mm-ss-tt")));
        //        if (stepType == "When")
        ...
        {
            //string TestEnvURL = AppSetting("TestEnvironmentURL")
